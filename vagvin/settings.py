...
MIDDLEWARE = [
    ...
    "vagvin.monitoring.PrometheusMonitoringMiddleware",
...
DEFAULT_FROM_EMAIL = os.environ.get(
    "DEFAULT_FROM_EMAIL", "VAGVIN <noreply@example.com>"
)
...
ALLOWED_ROBOKASSA_IPS = (
    os.environ.get("ALLOWED_ROBOKASSA_IPS", "").split(",")
    if os.environ.get("ALLOWED_ROBOKASSA_IPS")
    else []
)
...
YOOKASSA_RETURN_URL = os.environ.get(
    "YOOKASSA_RETURN_URL", "https://vagvin.ru/payments/status/"
)

# Heleket settings
HELEKET_API_URL = os.environ.get(
...
HELEKET_RETURN_URL = os.environ.get(
    "HELEKET_RETURN_URL", "https://vagvin.ru/payments/status/"
)
HELEKET_SUCCESS_URL = os.environ.get(
    "HELEKET_SUCCESS_URL", "https://vagvin.ru/payments/status/"
)
HELEKET_CALLBACK_URL = os.environ.get(
    "HELEKET_CALLBACK_URL", "https://vagvin.ru/payments/heleket/callback/"
)
