...
class Payment(BaseModel):
    ...
    provider = models.CharField(
        max_length=20, choices=PROVIDER_CHOICES, verbose_name="Платежная система"
    )
    amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Сумма")
    total_amount = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Сумма с комиссией"
    )
    invoice_id = models.CharField(
        max_length=100, unique=True, verbose_name="Идентификатор платежа"
    )
