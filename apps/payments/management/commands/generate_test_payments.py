    ...
    def handle(self, *args: Any, **options: Any) -> Optional[str]:
        ...
        if username:
            try:
                ...
                self.stdout.write(
                    self.style.WARNING(f"User {username} not found. Creating new user.")
                )
        ...
        self.stdout.write(
            self.style.MIGRATE_HEADING(f"Generating {count} test payments...")
        )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Successfully generated {payments_created} test payments."
            )
        )
        return None
