...
import requests
from apps.reports.services import AutotekaService, CarfaxService, VinhistoryService, AuctionService, AvitoAuthService, AvitoService
...
class TestReportAPIViews:
    ...
    def test_autoteka_check_view(self, mock_autoteka_check, client, superuser):
        ...
        response = client.post(reverse('reports:api_check_autoteka'), {'vin': 'TESTVIN1234567890'})
    ...
    def test_carfax_check_view(self, mock_carfax_check, client, superuser):
        ...
        response = client.post(reverse('reports:api_check_carfax_autocheck'), {'vin': 'TESTVIN1234567890'})
    ...
    def test_vinhistory_check_view(self, mock_vinhistory_check, client, superuser):
        ...
        mock_vinhistory_check.return_value = {"success": True, "message": "Vinhistory found"}

        response = client.post(reverse('reports:api_check_vinhistory'), {'vin': 'TESTVIN1234567890'})
    ...
    def test_auction_check_view(self, mock_auction_check, client, superuser):
        ...
        response = client.post(reverse('reports:api_check_auction'), {'vin': 'TESTVIN1234567890'})
...
class TestReportServices:
    ...
    @patch('apps.reports.services.requests.post')
    @patch('apps.reports.services.requests.get')
    def test_autoteka_service_check_success_polling(self, mock_get, mock_post, mock_get_token):
        ...
        mock_get.side_effect = [
            ...
            MagicMock(status_code=200, json=lambda: {"result": {"preview": {"status": "processing"}}}),
            # Second poll: success
            MagicMock(
                status_code=200,
                json=lambda: {
    ...
    def test_avito_service_extract_id(self):
        ...
        url_with_path = "https://www.avito.ru/moskva/avtomobili/vaz_lada_vesta_2021_2345678910"
