...
class TestUserService:
    ...
    def test_register_user_success(self):
        ...
        with patch('apps.accounts.services.EmailService.send_registration_email') as mock_send_email:
    ...
    def test_register_user_with_referral(self):
        ...
        with patch('apps.accounts.services.EmailService.send_registration_email') as mock_send_email:
            mock_send_email.return_value = True
            success, message, new_user = UserService.register_user("ref_user@example.com", referrer.referral_code)
    ...
    def test_reset_password_success(self):
        ...
        with patch('apps.accounts.services.EmailService.send_password_reset_email') as mock_send_email:
            mock_send_email.return_value = True
    ...
    def test_reset_password_too_soon(self):
        ...
        user = UserFactory(email="reset_soon@example.com", last_password_reset=timezone.now())
    ...
    def test_add_remove_additional_email(self):
        ...
        # Add email
        success, msg, emails = UserService.add_additional_email(user, "add1@example.com")
        assert success is True
        ...
        # Remove email
        success, msg, emails = UserService.remove_additional_email(user, "add1@example.com")
        assert success is True
