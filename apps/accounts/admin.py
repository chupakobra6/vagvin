...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (
            ...
            {"fields": ("referral", "referral_code", "referral_link_display")},
        ),
        (
            _("Additional Information"),
            {"fields": ("additional_emails", "last_password_reset")},
        ),
        (
            _("Permissions"),
            {
    ...
    def referral_link_display(self, obj):
        ...
        return format_html(
            '<a href="http://vagvin.ru{}" target="_blank">{}</a>',
            obj.referral_link,
            obj.referral_link,
        )
